package edmt.dev.kotlineatitv2server
...
import edmt.dev.kotlineatitv2server.common.Common
import edmt.dev.kotlineatitv2server.model.ServerUserModel
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRegisterDialog(user: FirebaseUser) {
        ...
        builder.setMessage("Please fill information \n Admin will accept yout account late")
            ...
            .setPositiveButton("REGISTER",{_, _ ->
                ...
                serverRef!!.child(serverUserModel.uid!!)
                    ...
                    .addOnCompleteListener{_ ->
                        dialog!!.dismiss()
                        Toast.makeText(this,"Register success ! Admi wil check and active user soon",Toast.LENGTH_SHORT).show()
                    }
            })
